...
export function handleFirestoreError(error: unknown, operationType: OperationType, path: string | null) {
  // SECURITY: Redact PII before logging or throwing
  const redact = (val: string | null | undefined) => val ? '[REDACTED]' : val;
  ...
  // SECURITY: Use centralized logger and throw generic error to client
