 ...
 * Prevents PII leakage by redacting sensitive user information.
 */
export function handleFirestoreError(error: unknown, operationType: OperationType, path: string | null) {
  ...
  // Use structured logging for better observability without exposing PII to the client
  logger.error({ err: error, metadata: errInfo }, 'Firestore Operation Failed');

  // Throw a generic error message to the client to prevent internal detail exposure
