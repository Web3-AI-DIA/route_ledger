...
// SECURITY: Extracts client IP address safely to mitigate IP spoofing in rate limiting.
// Prefers x-real-ip set by trusted edge proxy, then the first IP in x-forwarded-for.
